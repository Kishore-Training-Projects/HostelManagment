      ...
      >
        <section className="font-sans">
          <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
                        ...
                        <div className="w-full bg-white rounded-lg shadow shadow-2xl dark:border border-2 border-gray-400 md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
